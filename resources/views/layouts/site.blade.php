...
<head>
    ...
    <style>
        ...
        html.dark #cursor-glow { background: radial-gradient(circle, rgba(129,140,248,.3) 0%, transparent 70%); }
        ...
        html.dark {
            --bg: #0f172a; --surface: #1e293b; --surface-2: #1a2744;
            --border: #334155; --text: #e2e8f0; --muted: #94a3b8;
            --nav-bg: #0b1120; --nav-border: #1e293b;
        }
        *, *::before, *::after { transition: background-color .3s ease, border-color .3s ease, color .2s ease, box-shadow .3s ease; }
        ...
        .navbar-jornalzin { background: var(--nav-bg) !important; border-bottom: 1px solid var(--nav-border); box-shadow: 0 1px 8px rgba(0,0,0,.2); }
        ...
        .btn-dark-mode { background: transparent; border: 1.5px solid #475569; color: #94a3b8; border-radius: 50px; padding: .32rem .7rem; font-size: 1rem; cursor: pointer; transition: all .2s; display: flex; align-items: center; gap: .3rem; line-height: 1; }
        .btn-dark-mode:hover { border-color: #818cf8; color: #818cf8; }

        .btn-menu { background: #f1f5f9; border: 1px solid #e2e8f0; color: #334155; font-weight: 600; font-size: .88rem; border-radius: 50px; padding: .4rem 1rem; display: flex; align-items: center; gap: .5rem; cursor: pointer; transition: all .2s; }
        ...
        .btn-nav-login { border: 1.5px solid #94a3b8; color: #94a3b8; border-radius: 50px; padding: .35rem 1rem; font-size: .88rem; font-weight: 600; text-decoration: none; transition: all .2s; }
        .btn-nav-login:hover { border-color: #f1f5f9; color: #f1f5f9; }
        .btn-nav-cadastro { background: #4f46e5; color: #fff !important; border-radius: 50px; padding: .35rem 1rem; font-size: .88rem; font-weight: 600; text-decoration: none; transition: all .2s; border: 1.5px solid transparent; }
        ...
        html.dark .search-wrap input { background: var(--surface) !important; border-color: var(--border) !important; color: var(--text) !important; }
        ...
        html.dark .comment-form input { background: #0f172a !important; border-color: #334155 !important; color: #e2e8f0 !important; }
        ...
        footer { margin-top: 40px; padding: 20px; background: var(--surface-2); color: var(--muted); text-align: center; border-top: 1px solid var(--border); }
