        ...
        <div class="creator-body">
            ...
            <form method="POST" action="{{ route('users.store') }}" id="userForm">
                ...
                <div class="form-section">
                    ...
                    <select name="tipo" class="form-control-styled @error('tipo') is-invalid @enderror">
                        <option value="administrador" {{ old('tipo') === 'administrador' ? 'selected' : '' }}>
                            🛡️ Administrador
                        </option>
                        <option value="editor" {{ old('tipo') === 'editor' ? 'selected' : '' }}>
                            ✏️ Editor
                        </option>
                    ...
                    @error('tipo') <div class="invalid-msg">{{ $message }}</div> @enderror
                </div>
