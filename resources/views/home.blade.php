...
<style>
    ...
    .search-wrap button {
        ...
        border-radius: 50px; padding: .5rem 1.1rem; cursor: pointer;
    ...
    .home-video-wrap video { width: 100%; display: block; aspect-ratio: 16/9; }
    ...
    .btn-vote-mini {
        ...
        border: none; border-radius: 8px; font-size: .92rem;
    ...
    .comment-author {
        ...
        color: var(--text); margin-right: .4rem;
    }
    ...
    .comment-form button {
        ...
        background: var(--brand); color: #fff;
        border: none; font-size: .92rem; font-weight: 700;
        ...
        fetch(url)
            ...
            .then(data => {
                ...
                if (!novoPosts || novoPosts.innerHTML.trim() === '') {
                    hasMore = false;
                    loadingEl.innerHTML = '<p style="color:var(--muted);font-size:.9rem;">Não há mais postagens.</p>';
                    return;
                }
